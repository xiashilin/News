...
public class NewsActivity extends BaseActivity
    ...
    private void refrashData() {
        ...
        if (AVUser.getCurrentUser() != null) {
            ...
            Picasso.with(mContext).load(R.mipmap.ic_def_icon).into(imageView);
        }
        if (AVUser.getCurrentUser() == null)
            view.findViewById(R.id.tv_userName).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivityForResult(new Intent(NewsActivity.this, LoginActivity.class), 12);
                }
            });
    }
